  ...
  return (
    <ul className="social-links">
      <li className="social-icon">
        <a href="https://twitter.com/QueensULibrary">
          <img src={SocialTwitter} alt="Twitter" />
        </a>
      </li>

      <li className="social-icon">
        <a href="https://www.facebook.com/queenslibrary/">
          <img src={SocialFacebook} alt="Facebook" />
        </a>
      </li>

      <li className="social-icon">
        <a href="https://www.instagram.com/queensulibrary/">
          <img src={SocialInstagram} alt="Instagram" />
        </a>
      </li>

      <li className="social-icon">
        <a href="https://www.youtube.com/channel/UCx54VIAlOvLAcVA4VyybvTQ">
